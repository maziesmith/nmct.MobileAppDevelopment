package com.kristofcolpaert.week6oefening1tris.Data;
import android.graphics.drawable.Drawable;

import com.kristofcolpaert.week6oefening1tris.R;
...
public class Data {
	...
	public enum Horoscoop {
        ...
        public static Horoscoop getHoroscopeByName(String name)
        {
            for(Horoscoop horoscope : Horoscoop.values())
            {
                if(horoscope.getNaamHoroscoop() == name)
                    return horoscope;
            }
